...
public class LegsActionCodelet extends Codelet{
	...
	public void accessMemoryObjects() {
		legsActionMO=(MemoryContainer)this.getInput("LEGS");
                worldStateExploringDetectorMO=(MemoryObject)this.getOutput("EXPLORING_STATE_DETECTOR");
	}
				...
				JSONObject command=new JSONObject(comm);
                                if (command.has("ACTION")) {
                                    ...
                                    if(action.equals("FORAGE")){
                                               ...
                                               //if (!comm.equals(previousLegsAction)) 
                                                ...
                                                try {  
                                                      c.rotate(2);
                                                      worldStateExploringDetectorMO.setI("exploring");
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                }
                                               } 
					    ...
					    if (!comm.equals(previousLegsAction))
                                            ...
                                            try {
                                                 ...
                                                 worldStateExploringDetectorMO.setI("NOT_exploring");
                                            } catch(Exception e) {
                                                e.printStackTrace();
                                            }
